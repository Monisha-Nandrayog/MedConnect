...
public class AppointmentDAO {
	...
	public boolean addAppointment(Appointment appointment) {
		...
		try {
			...
			String sql = "insert into appointment(id,userId, fullName, gender, age, appointmentDate, email, phone, diseases, doctorId, address, status) values(?,?,?,?,?,?,?,?,?,?,?,?)";
			PreparedStatement pstmt = this.conn.prepareStatement(sql);

			pstmt.setInt(1, appointment.getId());
			pstmt.setInt(2, appointment.getUserId());
			pstmt.setString(3, appointment.getFullName());
			pstmt.setString(4, appointment.getGender());
			pstmt.setString(5, appointment.getAge());
			pstmt.setString(6, appointment.getAppointmentDate());
			pstmt.setString(7, appointment.getEmail());
			pstmt.setString(8, appointment.getPhone());
			pstmt.setString(9, appointment.getDiseases());
			pstmt.setInt(10, appointment.getDoctorId());
			pstmt.setString(11, appointment.getAddress());
			pstmt.setString(12, appointment.getStatus());
	...
	public List<Appointment> getAllAppointmentByLoginDoctor(int id) {
		List<Appointment> appList = new ArrayList<Appointment>();
