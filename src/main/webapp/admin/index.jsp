				...
				<div class="card my-card">
					<div class="card-body text-center text-danger">
						...
						<p class="fs-4 text-center ">
							<a href="view_doctor.jsp" style="text-decoration:none; " class="text-danger">Doctor
						</a> <br><%= totalNumberOfDoctor %>
			...
			<div class="col-md-6 mt-4">
				<div class="card my-card">
					<div class="card-body text-center text-danger">
						...
						<p class="fs-4 text-center">
						<a href="patient.jsp" style="text-decoration:none ;" class="text-danger">Total Appointment
						</a> 
							 <br><%= totalNumberOfAppointment %>
						</p>
					</div>
				</div>
