		...
		<div class="row">
			<div class="col-md-4">
				<div class="card my-card">
					...
					<div class="card-body">
						<p class="fs-3 text-center text-info">Change Password</p>

						<!-- for message -->
						<!-- success message -->
						<c:if test="${not empty successMsg }">
							<p class="text-center text-info fs-5">${successMsg}</p>
						...
						<form action="../doctorChangePassword" method="post">
							...
							<button type="submit" class="btn btn-info text-white col-md-12">Change
								Password</button>
						</form>
						<!-- doctor change password form -->
					</div>
			...
			<div class="col-md-6  offset-md-2">
				<div class="card my-card">
					...
					<div class="card-body">
						<p class="fs-3 text-center text-info">Edit Doctor Profile</p>
						...
						<!-- end of message -->
							...
							<form action="../doctorEditProfile" method="post">
								...
								<button type="submit"
									class="btn btn-info text-white col-md-12">Update</button>
							</form>
