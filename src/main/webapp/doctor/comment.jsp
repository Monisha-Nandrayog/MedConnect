...
<style type="text/css">
.my-card {
	box-shadow: 0px 0px 10px 1px #2d6a4f;
		...
		<div class="row">
			...
			<div class="col-md-6 offset-md-3">
				<div class="card my-card">
					<div class="card-body">
						<p class="text-center fs-3 text-info">Leave a Treatment Comment</p>
						...
						<form class="row g-3" action="../updateStatus" method="post">
							...
							<div class="col-md-12">
								<label class="form-label">Appointment Status</label><br>
								<!--  <textarea name="comment" placeholder="Leave a comment"
									class="form-control" rows="" cols=""></textarea>-->
									<input type="radio" name="comment" value="Confirmed"> Confirmed
									<input type="radio" name="comment" value="Cancelled"> Cancelled
									<input type="radio" name="comment" value="Pending"> Pending
							</div>
							...
							<div class="col-md-12">
								<button type="submit" class="btn btn-info col-md-12 text-white">Submit</button>
							</div>
