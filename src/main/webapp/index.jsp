...
<title>Home Page | MedConnect</title>
...
<body>
	...
	<div id="carouselExampleIndicators" class="carousel slide"
		...
		<div class="carousel-inner">
			...
			<div class="carousel-item">
			 ...
			 <div class="carousel-item">
				<img src="img/hospital1.jpg" class="d-block w-100" alt="..." height="580px" width="90%">
			</div>
			<div class="carousel-item">
				<img src="img/hospital2.jpg" class="d-block w-100" alt="..." height="580px" width="90%">
			</div>
			<div class="carousel-item">
				<img src="img/hospital3.jpg" class="d-block w-100" alt="..." height="580px" width="90%">
			</div> 
	...
	<div class="container p-3">
		<p class="text-center mt-2 mb-3 fs-2 myP-color">Some key Features of our
		...
		<div class="row">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="card my-card">
							<div class="card-body">
								<p class="fs-5 myP-color"> Healing Hands</p>
			...
			<!-- 2nd col -->
				...
				<div class="col-md-4 mt-2 mys-card" style="margin-left: -20px;">
					<img class="mt-3" alt="" src="img/12345.jpg" height="440px"
						width="470px">
				</div>
			...
			<div class="col-md-3">
				<div class="card my-card">
					<div class="card-body text-center">
						...
						<p class="fw-bold fs-5">Dr. Vikram</p>
			...
			<div class="col-md-3">
				<div class="card my-card">
					<div class="card-body text-center">
						...
						<p class="fw-bold fs-5">Dr. Yasmeen</p>
						<p class="fs-7">(Chief Doctor)</p>
					</div>
				</div>
			</div>
			...
			<div class="col-md-3">
				<div class="card my-card">
					<div class="card-body text-center">
						...
						<p class="fw-bold fs-5">Dr. Abhilasha</p>
						<p class="fs-7">(Dean)</p>
					</div>
				</div>
			</div>
